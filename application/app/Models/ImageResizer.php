...
class ImageResizer {
    ...
    static function resize($path, $width = null, $height = null) {
        ...
        if (file_exists($full_path) and is_file($full_path)) {
            ...
            if ( (isset($height) and is_numeric($height) and isset($width) and is_numeric($width)) or ($height == null and isset($width) and is_numeric($width)) or ( $width == null and isset($height) and is_numeric($height))) {
